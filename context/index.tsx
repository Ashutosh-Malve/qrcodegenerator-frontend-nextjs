    ...
    <QrStyleContext.Provider value={useMemo(() => ({ state, dispatch }), [state, dispatch])}>
      ...
      <div>
        ...
        <footer className="mb-3 mt-5 flex h-16 w-full flex-col items-center justify-between space-y-3 border-t px-3 pt-4 text-center sm:mb-0 sm:h-20 sm:flex-row sm:pt-2">
          <div>
            <p className="block text-center text-sm font-medium text-gray-500">
              {' '}
              Made with ♡ by{' '}
              <a
                className="font-medium text-gray-800 underline transition-colors"
                href="https://www.linkedin.com/in/ashutosh-malve/"
                target="_blank"
          ...
          <div className="flex space-x-4 pb-4 sm:pb-0">
            <Link href="https://twitter.com/malve" className="group" aria-label="TaxPal on Twitter">
            ...
            <Link
              href="https://github.com/ashutosh-malve"
              className="group"
